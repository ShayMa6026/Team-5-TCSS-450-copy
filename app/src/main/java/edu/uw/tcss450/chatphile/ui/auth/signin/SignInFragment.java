package edu.uw.tcss450.chatphile.ui.auth.signin;
...
import edu.uw.tcss450.chatphile.databinding.FragmentSignInBinding;
...
public class SignInFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.buttonToForget.setOnClickListener(button -> {
            Navigation.findNavController(requireView()).navigate(
                    SignInFragmentDirections.actionSignInFragmentToForgetVerifyFragment()
            );
        });
    }
