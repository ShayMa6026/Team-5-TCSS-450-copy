...
import edu.uw.tcss450.chatphile.databinding.FragmentChatRoomBinding;
...
public class ChatRoomFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mChatModel.getFirstMessages(ChatRoomFragmentArgs.fromBundle(getArguments()).getChatid(), mUserModel.getmJwt());
